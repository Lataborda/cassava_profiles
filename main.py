...
with LQD:
	...
	if DD == "**Laboratory quality data**":
		...
		if LAP == "Sweet cassava":
			...
			st.page_link("https://cdn.standards.iteh.ai/samples/13073/8f1ad914d6f0421ba804c4571d6830ca/ISO-6647-1987.pdf", label="Amylose percentage: Moreno J. et al. (2021)")
